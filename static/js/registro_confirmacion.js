...
async function validarDNS() {
  ...
  btn.innerHTML =
    '<span class="loading-spinner"></span> Verificando DNS...';


  resultadoDiv.style.display = "block";

  resultadoDiv.className =
    "resultado-box resultado-warning";


  resultadoDiv.innerHTML =
    `Verificando registro TXT en ${dominio}...`;
  ...
  try {
    ...
    if (data.exitoso) {
      ...
      resultadoDiv.className =
        "resultado-box resultado-success";
...
async function iniciarAuditoria() {
  ...
  btn.innerHTML =
    '<span class="loading-spinner"></span> Iniciando escaneo...';
...
async function esperarEscaneo(){
  ...
  estadoDiv.innerHTML =
    "El escaneo tarda más de lo esperado.";
